...
export default function AuthPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-muted/20 py-8 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="mt-4">
          ...
          {/* Social Login Buttons - Now positioned after the main form button */}
          {renderSocialButtons()}
        </div>
      </div>
    </div>
